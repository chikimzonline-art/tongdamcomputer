      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <UTUploadButton
            ...
            appearance={{
              button:
                "ut-ready:bg-emerald-600 ut-ready:text-white ut-ready:hover:bg-emerald-700 ut-uploading:bg-emerald-700/80 ut-uploading:text-white ut-uploading:cursor-not-allowed rounded-md px-4 py-2 text-sm font-medium transition-colors w-full",
